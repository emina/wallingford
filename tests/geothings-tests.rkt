...
(define (midpoint-test)
  (test-case
   ...
   (always (equal? midpoint (point-scale (point-plus (line-end1 line1) (line-end2 line1)) 0.5)) #:context c)
   (stay (line-end1 line1) #:priority low #:context c)
   (stay (line-end2 line1) #:priority low #:context c)
   (stay midpoint #:priority lowest #:context c)
